...
Lupus.prototype.getIcon = function(devicetype) {
  ...
  let fsicon = this.adapter.adapterDir + '/admin/icons/' + devicetype + '.jpg';
  let icon   = "";

  if (fs.existsSync(fsicon)) {

    icon = '/icons/' + devicetype + '.jpg';
