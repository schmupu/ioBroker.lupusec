...
__export(datapoints_exports, {
  getDeviceIconByDeviceType: () => getDeviceIconByDeviceType,
  getDeviceNameByDeviceType: () => getDeviceNameByDeviceType,
  getDeviceTypeList: () => getDeviceTypeList,
  getSMSTypeList: () => getSMSTypeList,
  getStatusTypeList: () => getStatusTypeList,
  getWebcamTypeList: () => getWebcamTypeList
});
    ...
    dc_ex: {
      ...
      common: {
        ...
        states: {
          ...
          de: { 0: "T\xFCr-/Fensterkontakt(e) offen", 1: "T\xFCr-/Fensterkontakt(e) geschlossen" }
        },
        min: 0,
        max: 1
      }
...
function getDeviceTypeList(devicetype, language) {
  var _a, _b;
...
function getDeviceIconByDeviceType(devicetype) {
  var _a;
  const deviceTypes = getDeviceTypes();
  if (devicetype === void 0)
    return;
...
function getDeviceNameByDeviceType(devicetype) {
  var _a;
  const deviceTypes = getDeviceTypes();
  if (devicetype === void 0)
    return;
...
function getStatusTypeList(language) {
  var _a;
...
function getSMSTypeList(language) {
  var _a;
...
function getWebcamTypeList(language) {
  var _a;
...
0 && (module.exports = {
  getDeviceIconByDeviceType,
  getDeviceNameByDeviceType,
  getDeviceTypeList,
  getSMSTypeList,
  getStatusTypeList,
  getWebcamTypeList
