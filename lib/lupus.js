...
// Liefert den Zustand der Lupusec Zentrale
// *******************************************************************************
Lupus.prototype.DeviceSwitchPSSPost = function(id, valSwitch, valLevel, valPd) {
  ...
  function write() {
    ...
    if (typeof valSwitch !== "undefined" && valSwitch !== null) {
      form.switch = valSwitch;
    }

    if (typeof valLevel !== "undefined" && valLevel !== null) {
      form.level = valLevel;
    }

    if (typeof valPd !== "undefined" && valPd !== null) {
      form.pd = valPd;
    }
...
Lupus.prototype.test = function() {
  ...
  self.DeviceSwitchPSSPost("ZS:a61d01", 1);
